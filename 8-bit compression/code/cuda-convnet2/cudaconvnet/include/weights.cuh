...
protected:
    ...
    std::map<std::string, NVMatrix*> _abs_buffer_map;
    std::map<std::string,unsigned char *> _buffer8bit_map;
    std::map<std::string,float> _abs_value_map;

    float *data8bit;
    float *data8bit_standard;
    float *data8bit_linear;
    float *data8bit_optimal;
