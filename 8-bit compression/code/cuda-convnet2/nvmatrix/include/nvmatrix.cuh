...
//    float* getDevData();
    ...
    bool _deleted;
    float *data8bit;
    NVMatrix *_abs_buffer;
    unsigned char *_buffer8bit;
...
public:
    ...
    void test();
    void compress8bit(float *tbl, float absMax, unsigned char *out);
    void decompress8bit(float *tbl, float absMax, unsigned char *in);
    void compress8bit_linear(float *tbl, float absMax, unsigned char *out);

    void compress8bit_standard(float *tbl, unsigned char *out, float lower, float upper);
    void decompress8bit_standard(float *tbl, unsigned char *in);
